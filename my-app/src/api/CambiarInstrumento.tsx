...
export async function CambiarInstrumentoAsync(id: number, data: Instrumento) {
  try {
    const response = await fetch(`https://struggle-smooth-earnings-girlfriend.trycloudflare.com/cambiarinstrumento/${id}`, {
      method: 'PUT',
      headers: {
