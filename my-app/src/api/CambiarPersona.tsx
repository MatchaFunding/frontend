...
export async function CambiarPersonaAsync(id: number, data: Persona) {
  try {
    const response = await fetch(`https://struggle-smooth-earnings-girlfriend.trycloudflare.com/cambiarpersona/${id}/`, {
      method: 'PUT',
      headers: {
