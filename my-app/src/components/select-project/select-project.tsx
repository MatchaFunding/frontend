  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await fetch(`https://backend.matchafunding.com/usuarios/${empresaId}/proyectos`);
        if (!response.ok)
        ...
        <div className="select-project-modal__content">
          ...
          {mode === 'unlink' ? (
            ...
            <div className="select-project-modal__projects-section">
              ...
              <div className="select-project-modal__header-row">
                <h3>Selecciona un proyecto</h3>
                <div className="select-project-modal__search-container">
                  <div className="select-project-modal__search-wrapper">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="select-project-modal__search-icon">
