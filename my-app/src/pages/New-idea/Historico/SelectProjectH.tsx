...
const mockProyectosUsuario: Proyecto[] = [
  { id: 101, nombre: 'Plataforma Educativa Interactiva', resumen: 'Una app para mejorar el aprendizaje de matemáticas en secundaria.', area: 'Educación' },
  { id: 102, nombre: 'Sistema de Riego Inteligente', resumen: 'Uso de sensores IoT para optimizar el consumo de agua en la agricultura.', area: 'Sostenibilidad' },
  { id: 103, nombre: 'Marketplace de Artesanos Locales', resumen: 'Conectar artesanos con un mercado más amplio a través de una plataforma de e-commerce.', area: 'Tecnología' },
];
...
const ProjectCard: React.FC<{ proyecto: Proyecto; onSelect: () => void }> = ({ proyecto, onSelect }) => (
  <div className="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 flex flex-col border border-slate-200/80">
    <div className="p-6 flex flex-col flex-grow text-center">
      <h3 className="text-xl font-bold text-[#44624a] mb-2">{proyecto.nombre}</h3>
      <p className="text-slate-600 text-sm flex-grow mb-4">{proyecto.resumen}</p>
